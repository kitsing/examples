...
def evaluate(data_source):
    ...
    with torch.no_grad():
        ...
        # for i in range(0, data_source.size(0) - 1, 1):
            ...
            targets_masks = (targets_flatten != corpus.dictionary.word2idx[corpus.padding]).to(torch.get_default_dtype())
    ...
    return total_loss / (data_source[1:, :] != corpus.dictionary.word2idx[corpus.eos]).sum().item()
